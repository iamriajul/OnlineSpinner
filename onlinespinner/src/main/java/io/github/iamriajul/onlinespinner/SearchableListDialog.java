...
public class SearchableListDialog extends DialogFragment implements
    ...
    private OnlineSpinnerArrayAdapter listAdapter;
    ...
    private void setData(View rootView) {
        ...
        listAdapter = new OnlineSpinnerArrayAdapter(getActivity(), android.R.layout.simple_list_item_1,
                items);
...
//                _listViewItems.clearTextFilter();
            ((OnlineSpinnerArrayAdapter) _listViewItems.getAdapter()).getFilter().filter(null);
        } else {
            ((OnlineSpinnerArrayAdapter) _listViewItems.getAdapter()).getFilter().filter(s);
        }
